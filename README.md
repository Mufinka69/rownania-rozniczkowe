...
Rozwiązanie: $y(t) = 3e^t − 3e^{2t} + e^{3t}$ 
...
a tutaj rozwiązanie metodą Rungego-Kutty-Fehlberga z początkowym krokiem $h = 0.1$ oraz tolerancją błędu równą $1e-6$ na przedziale $t \in [0, 100]$.
